...
@app.route("/googleed17d1a863e74042.html")
def google_site_verification():
    return "google-site-verification: googleed17d1a863e74042.html", 200, {"Content-Type": "text/plain; charset=utf-8"}

@app.route("/robots.txt")
def robots_txt():
    return "User-agent: *\nAllow: /\n\nSitemap: https://skill-arena101-1-2fxu.onrender.com/sitemap.xml\n", 200, {"Content-Type": "text/plain; charset=utf-8"}


@app.route("/sitemap.xml")
def sitemap_xml():
    return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<urlset xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\">\n  <url><loc>https://skill-arena101-1-2fxu.onrender.com/</loc></url>\n</urlset>\n", 200, {"Content-Type": "application/xml; charset=utf-8"}
